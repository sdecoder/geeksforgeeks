...
string changeGender(string str) {
  ...
  unordered_multimap<string, string> dictionary = {
      {"batman", "batwoman"}, {"batwoman", "batman"}, {"boy", "girl"}, {"girl", "boy"},
      {"boyfriend", "girlfriend"}, {"girlfriend", "boyfriend"}, {"father", "mother"},
      {"mother", "father"}, {"husband", "wife"}, {"wife", "husband"}, {"he", "she"},
      {"she", "he"}, {"his", "her"}, {"her", "his"}, {"male", "female"},
      {"female", "male"}, {"man", "woman"}, {"woman", "man"}, {"Mr", "Ms"}, {"Mr", "Ms"},
      {"sir", "madam"}, {"madam", "sir"}, {"son", "daughter"}, {"daughter", "son"},
  ...
  for (int i = 0; i <= n - 1; i++) {
    if (str[i] != ' ')
      ...
      if (dictionary.find(temp) != dictionary.end()) temp = dictionary.find(temp)->second;
...
int main() {
  string str =
      "she is going to watch movie with"
      " her boyfriend";
